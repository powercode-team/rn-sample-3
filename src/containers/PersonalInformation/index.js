...
class PersonalInformation extends Component {
  ...
  handleDatePicked = date => {
    this.setState({ dateOfBirth: Number(date) });
    this.hideDatePicker();
  };
  ...
  onPEPersonChange = () => {
    this.setState(prevState => ({ isPEPerson: !prevState.isPEPerson }));
  };

  onChangeDatePicked = event => {
    this.setState({ dateOfBirth: event.target.value.toISOString() });
  };
          ...
          >
            ...
            <Card style={styles.card}>
              ...
              <Picker
                ...
                error={
                  educationLevelErr && educationLevel !== this.PICKER_VALUE_FOR_ADDITIONAL_FILED
                }
              />
